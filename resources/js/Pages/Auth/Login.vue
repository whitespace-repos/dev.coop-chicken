        ...
        <form @submit.prevent="submit">
            ...
            <div class="block mt-4">
                <label class="flex items-center">
                    <BreezeCheckbox name="remember" v-model:checked="form.remember"  class="text-white"/>
            ...
            <div class="flex items-center justify-end mt-4">
                ...
                <BreezeButton class="ml-4 bg-white text-primary" :class="{ 'opacity-25': form.processing }" :disabled="form.processing">
                    Log in
                </BreezeButton>
            </div>
        </form>
